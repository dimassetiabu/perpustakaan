         ...
         <form action="" method="post">
            ...
            <div class="mt-3 d-flex flex-wrap gap-3">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="id peminjaman" name="id_buku" id="id_buku"
            ...
            <div class="d-flex flex-wrap gap-3">
               <div class="mb-3">
                  ...
                  <input type="number" class="form-control" placeholder="Nisn Siswa" name="nisn" id="nisn"
                     value="<?= $item["nisn"]; ?>" readonly>
               </div>
               <div class="mb-3">
               ...
               <div class="mb-3">
                  ...
                  <input type="number" class="form-control" placeholder="Id Admin" name="id_admin" id="id_admin"
            ...
            <div class="d-flex flex-wrap gap-4">
               ...
               <div class="mb-3">
                  ...
                  <input type="date" class="form-control" name="buku_kembali" id="buku_kembali"
                     value="<?php echo date('Y-m-d'); ?>" oninput="hitungDenda()">
                  <!--readonly-->
               </div>
            </div>
            <?php endforeach; ?>
